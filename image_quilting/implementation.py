...
class ImageQuilting_AlgorithmAssignment(ImageQuilting):
    ...
    def find_matching_texture_patch_indeces(
        ...
        def extract_canvas_overlap() -> np.ndarray:
            ...
            canvas_overlap = canvas_patch[block_overlap.top : block_overlap.bottom, block_overlap.right : block_overlap.left, :]
...
#maybe done idk
        ...
        def extract_overlap(patch: np.ndarray) -> np.ndarray:
            ...
            # Calculate the overlap area indices in the patch
            ...
            # Extract the overlap area from the patch
            patch_overlap = patch[
